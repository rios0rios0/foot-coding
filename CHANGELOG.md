...
- refreshed `.github/copilot-instructions.md` to document the `checks.yaml` workflow and its shared `quality:basic-checks` gate
...
- added `CLAUDE.md` with architecture, build, and convention guidance for Claude Code sessions
